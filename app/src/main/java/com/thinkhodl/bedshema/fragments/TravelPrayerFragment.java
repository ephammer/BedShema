 ...
 */
public class TravelPrayerFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        PrayerAdapter mAdapter = new PrayerAdapter(PrayerLists.getmTphilathHaerech(), getActivity());
