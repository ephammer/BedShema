 ...
 */
public class BirkathHalevanahFragment extends Fragment {
    @Nullable
    @BindView(R.id.recycler_view)
    RecyclerView mRecyclerView;

    public BirkathHalevanahFragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        PrayerAdapter mAdapter = new PrayerAdapter(PrayerLists.getmBirkathHalevanah(), getActivity());
